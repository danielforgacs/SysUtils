...
# installs / uninstalls
sudo apt purge -y ghostscript-x ghostscript ghostscript:i386
sudo apt update
...
sudo apt install -y doublecmd-gtk ranger curl vim tree gnome-tweaks usb-creator-gtk docker-compose smartmontools
